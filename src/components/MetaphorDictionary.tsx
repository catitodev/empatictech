...
export default function MetaphorDictionary() {
  ...
  return (
    <div className="bg-white border border-[#E5E1D5] rounded-3xl p-6 shadow-xs" id="metaphor-dictionary-container">
      <div className="flex items-center gap-2.5 mb-4">
        <BookOpen className="w-5 h-5 text-[#5A6E5F]" />
        <h3 className="text-base font-serif italic font-bold text-[#4A4842]">
