  ...
  return (
    <div className="min-h-screen bg-natural-bg dark:bg-dark-base text-natural-dark dark:text-dark-text flex flex-col font-sans antialiased selection:bg-natural-sage/20" id="app-root">
      ...
      <footer className="bg-natural-sidebar/70 dark:bg-dark-elevated/70 backdrop-blur-md border-t border-natural-border/50 dark:border-dark-border/50 py-6 text-center mt-12" id="app-footer">
        <div className="max-w-7xl mx-auto px-4 text-xs text-natural-taupe dark:text-dark-muted space-y-3">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 text-[10px] text-natural-taupe/70 dark:text-dark-muted/70">
            <span>Desenvolvido por <a href="https://github.com/catitodev" target="_blank" rel="noopener noreferrer" className="text-natural-sage hover:underline font-semibold">catitodev</a></span>
            <span className="hidden sm:inline">·</span>
            <span>Licença <a href="https://github.com/catitodev/empatictech/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="text-natural-sage hover:underline font-semibold">Apache 2.0</a></span>
          </div>
        </div>
      </footer>
    </div>
